...
This helper is intentionally manual. Marketior runtime does not probe Keychain.
Use this script when you want to bridge an existing Claude Code login into an
environment variable or an exported credentials file for Marketior.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manually export Claude Code OAuth credentials from macOS Keychain for Marketior.",
    )
    parser.add_argument(
        "--service",
