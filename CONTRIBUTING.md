# Contributing to Marketior

Thank you for your interest in contributing to Marketior! This guide will help you set up your development environment and understand our development workflow.
...
|---------|-----------|------------|-------|
| `make dev` on one machine | 4 vCPU, 8 GB RAM | 8 vCPU, 16 GB RAM | Best when Marketior uses hosted model APIs. |
...
`2 vCPU / 4 GB` environments often fail to start reliably or become unresponsive under normal Marketior workloads.
...
```text
unable to get image 'marketior-gateway': permission denied while trying to connect to the Docker daemon socket at unix:///var/run/docker.sock
```
...
- Check existing [Issues](https://github.com/bytedance/marketior/issues)
- Read the [Documentation](backend/docs/)
- Ask questions in [Discussions](https://github.com/bytedance/marketior/discussions)

## License

By contributing to Marketior, you agree that your contributions will be licensed under the [MIT License](./LICENSE).
