...
1. Start Marketior locally using any working development setup you already use.
   ...
   If you already have Marketior running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.marketior/memory.json`
