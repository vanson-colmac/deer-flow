...
This directory contains detailed documentation for the Marketior backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs MarketiorClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to Marketior?** Start with [SETUP.md](SETUP.md) for quick installation
