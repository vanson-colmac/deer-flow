"""End-to-end demo: SafetyFinishReasonMiddleware on the real Marketior lead-agent.

What it proves
--------------
- The real ``make_lead_agent`` / ``MarketiorClient`` pipeline is built (full
...
def main() -> int:
    ...
    # at import time via ``from marketior.models import create_chat_model``,
    ...
    # imported names.
    import marketior.agents.lead_agent.agent as lead_agent_module
    import marketior.client as client_module
