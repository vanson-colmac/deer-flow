...
Requirements:
    ...
    resolves marketior-harness and app packages correctly:
...
async def main():
    ...
    # Delay the rest of the marketior imports until *after* logging is installed
    # so that any import-time side effects (e.g. marketior.agents starts a
    ...
    from marketior.mcp import initialize_mcp_tools
