...
Controls BOTH the LangGraph checkpointer and the Marketior application
...
({sqlite_dir}/marketior.db) with WAL journal mode enabled on every
...
class DatabaseConfig(BaseModel):
    ...
    sqlite_dir: str = Field(
        default=".marketior/data",
        description=("Directory for the SQLite database file. Both checkpointer and application data share {sqlite_dir}/marketior.db."),
    )
    postgres_url: str = Field(
        ...
        description=(
            ...
            "Example: postgresql://user:pass@host:5432/marketior "
    ...
    def sqlite_path(self) -> str:
        ...
        return os.path.join(self._resolved_sqlite_dir, "marketior.db")
