...
``langchain_openai.ChatOpenAI`` currently ignores that field, so Marketior's
...
which Marketior already understands.
"""
...
class PatchedChatMiniMax(ChatOpenAI):
    ...
    def _strip_user_message_names(payload: dict) -> None:
        ...
        Marketior middlewares tag user messages with internal provenance names
