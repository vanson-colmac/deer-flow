...
from marketior.agents.lead_agent.agent import build_middlewares
...
from marketior.tools.builtins.tool_search import assemble_deferred_tools
from marketior.tracing import build_tracing_callbacks, inject_langfuse_metadata
        ...
        *,
        ...
        Args:
            ...
            environment: Deployment environment label that ends up in
                ...
                ``MARKETIOR_ENV`` or ``ENVIRONMENT`` env vars. Pass an
    ...
    def stream(
        ...
        * ``StreamBridge`` is an asyncio-queue decoupling producers from
        ...
        inject_langfuse_metadata(
            ...
            environment=self._environment or os.environ.get("MARKETIOR_ENV") or os.environ.get("ENVIRONMENT"),
        )
