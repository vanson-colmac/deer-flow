...
from marketior.config.reload_boundary import format_field_description
...
from marketior.config.safety_finish_reason_config import SafetyFinishReasonConfig
...
class AppConfig(BaseModel):
    ...
    log_level: str = Field(
        ...
        description=format_field_description(
            "log_level",
            field_doc="Logging level for marketior and app modules (debug/info/warning/error); third-party libraries are not affected.",
        ),
    )
