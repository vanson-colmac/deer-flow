...
# Deployments can override via env var MARKETIOR_WRITE_FILE_MAX_BYTES; set to
# 0 (or negative) to disable the guard entirely.
_WRITE_FILE_CONTENT_MAX_BYTES = 80 * 1024
_WRITE_FILE_MAX_BYTES_ENV = "MARKETIOR_WRITE_FILE_MAX_BYTES"
...
def _effective_write_file_max_bytes() -> int:
    ...
    Reads ``MARKETIOR_WRITE_FILE_MAX_BYTES`` at call time (not import time)
...
def write_file_tool(
    ...
    Operators can override the cap via env var `MARKETIOR_WRITE_FILE_MAX_BYTES`
