...
from marketior.tools.builtins.tool_search import get_deferred_tools_prompt_section
...
[citation:Marketior Documentation](https://deer-flow.dev/docs).
...
- [Marketior Documentation](https://deer-flow.dev/docs) - Technical specifications
