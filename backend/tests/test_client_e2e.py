...
def e2e_env(tmp_path, monkeypatch):
    ...
    from marketior.agents.lead_agent.agent import build_middlewares as _original_build_middlewares
    ...
    monkeypatch.setattr("marketior.client.build_middlewares", _sync_safe_build_middlewares)
