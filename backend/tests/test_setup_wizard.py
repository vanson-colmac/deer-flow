...
class TestProviders:
    ...
    def test_llm_providers_cover_config_example_families(self):
        ...
        assert providers["gemini_openai_gateway"].use == "marketior.models.patched_openai:PatchedChatOpenAI"
        assert providers["mimo"].use == "marketior.models.patched_mimo:PatchedChatMiMo"
        assert providers["deepseek"].use == "marketior.models.patched_deepseek:PatchedChatDeepSeek"
...
class TestBuildMinimalConfig:
    ...
    def test_patched_thinking_provider_defaults_are_preserved(self):
        ...
        data = yaml.safe_load(content)
        model = data["models"][0]
        assert model["use"] == "marketior.models.patched_mimo:PatchedChatMiMo"
