...
export const HTML_PREVIEW_SCROLL_MESSAGE_SOURCE =
  "marketior-artifact-preview-scroll";
...
function htmlScrollRestorationScript(messageKey: string) {
  return `<script data-marketior-artifact-scroll-restoration>
(() => {
...
export function appendHtmlPreviewScrollRestoration(
  ...
  if (content.includes("data-marketior-artifact-scroll-restoration")) {
    return content;
  }
