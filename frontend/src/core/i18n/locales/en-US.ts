...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to Marketior.AI, an open source super agent. With built-in and custom skills, Marketior.AI helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Marketior.AI. With customized skills,\nMarketior.AI can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Marketior.AI is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Marketior.AI could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Marketior.AI",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Marketior.AI faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Marketior.AI looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "Marketior.AI automatically learns from your conversations in the background. These memories help Marketior.AI understand you better and deliver a more personalized experience.",
    ...
    models: {
      title: "LLM Models",
      description: "Manage your AI model configurations, API keys, and endpoints.",
      addModel: "Add Model",
      editModel: "Edit Model",
      deleteModel: "Delete",
      deleteConfirm: "Are you sure you want to delete this model? This action cannot be undone.",
      noModels: "No models configured",
      noModelsDescription: "Add your first LLM model to start using AI capabilities.",
      fieldName: "Name",
      fieldNamePlaceholder: "e.g. gpt-4o-custom",
      fieldModel: "Model ID",
      fieldModelPlaceholder: "e.g. gpt-4o",
      fieldDisplayName: "Display Name",
      fieldDisplayNamePlaceholder: "e.g. GPT-4o Custom",
      fieldProvider: "Provider Class",
      fieldProviderPlaceholder: "e.g. langchain_openai:ChatOpenAI",
      fieldApiKey: "API Key",
      fieldApiKeyPlaceholder: "sk-... or $OPENAI_API_KEY",
      fieldBaseUrl: "Base URL",
      fieldBaseUrlPlaceholder: "e.g. https://api.openai.com/v1",
      thinkingSupport: "Supports Thinking",
      reasoningEffortSupport: "Supports Reasoning Effort",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Marketior.AI.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "Marketior.AI only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "Marketior.AI",
