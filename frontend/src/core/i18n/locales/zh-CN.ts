...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 Marketior.AI，一个完全开源的超级智能体。通过内置和自定义的 Skills，\nMarketior.AI 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 Marketior.AI 的潜力。通过自定义技能，Marketior.AI\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，Marketior.AI 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 Marketior.AI 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 Marketior.AI 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 Marketior.AI。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 Marketior.AI 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      memory: "记忆",
    ...
    memory: {
      title: "记忆",
      description:
        "Marketior.AI 会在后台不断从你的对话中自动学习。这些记忆能帮助 Marketior.AI 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    models: {
      title: "LLM 模型",
      description: "管理你的 AI 模型配置、API 密钥和端点。",
      addModel: "添加模型",
      editModel: "编辑模型",
      deleteModel: "删除",
      deleteConfirm: "确定要删除该模型吗？此操作不可撤销。",
      noModels: "暂无模型配置",
      noModelsDescription: "添加你的第一个 LLM 模型以启用 AI 能力。",
      fieldName: "名称",
      fieldNamePlaceholder: "例如 gpt-4o-custom",
      fieldModel: "模型 ID",
      fieldModelPlaceholder: "例如 gpt-4o",
      fieldDisplayName: "显示名称",
      fieldDisplayNamePlaceholder: "例如 GPT-4o Custom",
      fieldProvider: "提供者类",
      fieldProviderPlaceholder: "例如 langchain_openai:ChatOpenAI",
      fieldApiKey: "API 密钥",
      fieldApiKeyPlaceholder: "sk-... 或 $OPENAI_API_KEY",
      fieldBaseUrl: "基础 URL",
      fieldBaseUrlPlaceholder: "例如 https://api.openai.com/v1",
      thinkingSupport: "支持 Thinking 模式",
      reasoningEffortSupport: "支持推理深度",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 Marketior.AI 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "Marketior.AI 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
