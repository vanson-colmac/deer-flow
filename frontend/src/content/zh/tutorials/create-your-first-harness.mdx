...
description: 本教程介绍如何以编程方式使用 Marketior.AI Harness Python SDK——直接在你的 Python 代码中导入和使用 Marketior.AI，而不是通过 Web 界面。
---

# 创建你的第一个 Harness

本教程介绍如何以编程方式使用 Marketior.AI Harness Python SDK——直接在你的 Python 代码中导入和使用 Marketior.AI，而不是通过 Web 界面。
