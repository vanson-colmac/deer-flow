---
title: 使用记忆系统
description: 本教程介绍如何在 Marketior.AI 中启用和使用记忆系统，让 Agent 在多次会话中记住关于你的重要信息。
---

# 使用记忆系统

本教程介绍如何在 Marketior.AI 中启用和使用记忆系统，让 Agent 在多次会话中记住关于你的重要信息。
...
记忆存储在 `backend/.marketior/memory.json`，你可以直接查看和编辑：
...
- [部署你的 Marketior.AI](/docs/tutorials/deploy-your-own-marketior)
