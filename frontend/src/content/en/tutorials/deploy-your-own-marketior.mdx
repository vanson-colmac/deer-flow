...
description: This tutorial guides you through deploying Marketior.AI to a production environment using Docker Compose for multi-user access.
---

import { Callout, Steps } from "nextra/components";

# Deploy Your Own Marketior.AI

This tutorial guides you through deploying Marketior.AI to a production environment using Docker Compose for multi-user access.
...
- Back up `backend/.marketior/` directory regularly
