...
description: This tutorial shows you how to enable and use Marketior.AI's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use Marketior.AI's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.marketior/memory.json`:

```bash
cat backend/.marketior/memory.json
```
...
```
backend/.marketior/agents/{agent_name}/memory.json
```
...
- [Deploy Your Own Marketior.AI](/docs/tutorials/deploy-your-own-marketior)
