...
description: This tutorial shows you how to use the Marketior.AI Harness programmatically — importing and using Marketior.AI directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the Marketior.AI Harness programmatically — importing and using Marketior.AI directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- Marketior.AI repository cloned
