...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes Marketior.AI capable of real action, not just
  conversation.
</Callout>
...
Marketior.AI supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: marketior-sandbox)
...
| `.marketior/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
