 ...
 * + MARKETIOR_RECORD_OUT in the environment — never run in CI.
 *
  ...
  webServer: [
    {
      ...
      env: {
        ...
        ...(process.env.MARKETIOR_RECORD_OUT
          ? { MARKETIOR_RECORD_OUT: process.env.MARKETIOR_RECORD_OUT }
          : {}),
    ...
    },
    {
      ...
      env: {
        ...
        MARKETIOR_INTERNAL_GATEWAY_BASE_URL: "http://127.0.0.1:8012",
      },
    },
  ],
});
